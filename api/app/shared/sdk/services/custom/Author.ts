...
export class AuthorApi extends BaseLoopBackApi {
  ...
  public getCurrent(): any {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/Authors" + "/:id";
   ...
   * call to {@link sdk.Author#login} or
   * {@link sdk.Author#getCurrent}. Return null when there
  ...
  /**
   * @name sdk.Author#isAuthenticated
   *
